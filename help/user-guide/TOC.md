---
user-guide-title: Documentation Marketo Optimizer
...
+ Fonctionnalités du collaborateur {#coworker}
  + [Interface de conversation](./agents/chat-interface.md)
  + [Compétences](./agents/skills.md)
  + [Créer un programme à partir d’un brief](./agents/program-from-brief.md)
  + [Créer des audiences pour les programmes](./agents/audience-creation.md)
...
+ Rapports {#reports}
  ...
  + [Personne Parcours Individu](./reports/person-journey-individual-report.md)
  + [Engagement](./reports/engagement-report.md)
  + [Engagement des e-mails](./reports/email-engagement-report.md)
  + [Engagement web](./reports/web-engagement-report.md)
  + [Jeux de données Experience Platform](./reports/aep-datasets.md)
+ Audiences {#audiences}
